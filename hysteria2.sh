...
insthysteria(){
    ...
    wget -N https://raw.githubusercontent.com/coolaj/hysteria2/main/install_server.sh
...
update_core(){
    wget -N https://raw.githubusercontent.com/coolaj/hysteria-install/main/hy2/install_server.sh
    bash install_server.sh
